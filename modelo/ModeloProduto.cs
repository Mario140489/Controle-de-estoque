...
namespace Modelo
{
    public class ModeloProduto
    {
        ...
        public ModeloProduto(int pro_cod, String pro_nome, String pro_descricao, Double pro_valorpago, Double pro_valorvenda, Double pro_qtde,
        ...
        public ModeloProduto(int pro_cod, String pro_nome, String pro_descricao, Double pro_valorpago, Double pro_valorvenda, float pro_qtde,
            int umed_cod, int cat_cod, int scat_cod)
        {
            this.ProCod = pro_cod;
            this.ProNome = pro_nome;
